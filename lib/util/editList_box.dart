...
class EditListBox extends StatefulWidget {
  ...
  final Function(String, IconData, int) onListInfoUpdated;
...
class _EditListBoxState extends State<EditListBox> {
  ...
  void initState() {
    super.initState();
    _textEditingController = TextEditingController(text: widget.initialListName);
            ...
            Expanded(
              child: Stack(
                children: [
                  ...
                  // Bottom edge gradient to indicate more icons
                  Positioned(
                    left: 0,
                    right: 0,
                    bottom: 0,
              ...
              children: [
                ...
                MyButton(
                  ...
                  onPressed: () {
                    ...
                    final colorValue = selectedColor.value; // Convert Color to int
                    if (listName.isNotEmpty) {
                      widget.onListInfoUpdated(listName, iconData, colorValue);
                    }
                    Navigator.of(context).pop();
                  },
                  color: Theme.of(context).colorScheme.secondary,
